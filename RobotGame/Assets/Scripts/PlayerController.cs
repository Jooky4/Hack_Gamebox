...
public class PlayerController : MonoBehaviour
{
    ...
    private CapsuleCollider col; // теперь прийдется использовать CapsuleCollider
    ...
    private bool isGrounded
    {
        get
        {
            var bottomCenterPoint = new Vector3(col.bounds.center.x, col.bounds.min.y, col.bounds.center.z);
            ...
            return Physics.CheckCapsule(col.bounds.center, bottomCenterPoint, col.bounds.size.x / 2 * 0.9f, GroundLayer);
